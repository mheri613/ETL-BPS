...
$tableData = getTableData($_GET['var_id']);
...
if ($tableData['success'] && !empty($tableData['data'])) {
    ...
    echo "<thead>";
    echo "<tr>";
    if (in_array("wilayah", $filter)) {
        echo "<th scope='col'>Wilayah</th>";
    }
    if (in_array("tahun", $filter)) {
        echo "<th scope='col'>Tahun</th>";
    }
    if (in_array("jumlah", $filter)) {
        echo "<th scope='col'>Jumlah</>";
    }
    if (in_array("satuan", $filter)) {
        echo "<th scope='col'>Satuan</th>";
    }
    if ((!in_array("wilayah", $filter) && !in_array("tahun", $filter) && !in_array("jumlah", $filter) && !in_array("satuan", $filter)) || !$filter) {
        echo "<th scope='col'>Wilayah</th>";
        echo "<th scope='col'>Tahun</th>";
        echo "<th scope='col'>Jumlah</>";
        echo "<th scope='col'>Satuan</th>";
